        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="box-header with-border">
                    ...
                    <button title="Clique aqui para excluir o processo!" name='botao' value='excluir' onclick="return confirm('Você tem certeza da exclusão?')" type="submit" class="btn btn-lg btn-danger pull-right">Excluir Processo</button> {{-- Colocar status "Excluido" --}}
                  </div>
