            ...
            <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                    <ul class="nav nav-pills nav-stacked">
                        <li><a href="#" onclick="showReport('analiticoUnidade')"><i class="fa fa-users text-light-blue"></i> RELATÓRIO ANALITICO</a></li>
                    </ul>
                </div>
            </div>
            <!-- /.box-body -->
    ...
    function showReport(relatorio) {
                            ...
                            switch (relatorio) {
                                case "analiticoUnidade":
                                    var url = '{{ route("relatorios.analiticoUnidade",":mesAno")}}';
                                    break;
                            }
