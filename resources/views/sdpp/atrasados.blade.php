...
@section('title', 'Processos com mais de 20 dias')
@section('link', 'PROCESSO / LISTAR PROCESSOS')
@section('conteudo')
            ...
            <table class="rTable" id="processAll">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {{-- <th>{{ $processo->NUP }}</th> --}}
                        <th>{{ $processo->getDataFormatada() }}</th>
                        <th>{{ $processo->DT_DOC_RESPOSTA }}</th>
                        <th>{{ $processo->BANCO }}</th>
                        ...
                        <th><a class="btn btn-small" href="{{route('processoSdpp.reiterarProcesso', $processo->ID)}}">
                            <i class="fa fa-undo">
                            </i>
                        </a></th>
                    </tr>
